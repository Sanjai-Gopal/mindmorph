      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data}>
            ...
            <Tooltip
              contentStyle={{ background: "#0f172a", border: "1px solid rgba(148,163,184,0.35)", borderRadius: 10 }}
              labelStyle={{ color: "#cbd5e1" }}
            />
            <Area type="monotone" dataKey="thisWeek" stroke="#22d3ee" fill="url(#focusGrad)" strokeWidth={2} />
            <Line type="monotone" dataKey="lastWeek" stroke="#a78bfa" dot={false} strokeWidth={2} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
